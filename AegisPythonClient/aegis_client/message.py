...
class MessageType(IntEnum):
    ...
    CHAT_LIST_REQUEST = ProtocolConstants.TYPE_CHAT_LIST_REQUEST
    CHAT_LIST_RESPONSE = ProtocolConstants.TYPE_CHAT_LIST_RESPONSE
    PRIVATE_CHAT_HISTORY_REQUEST = ProtocolConstants.TYPE_PRIVATE_CHAT_HISTORY_REQUEST
    PRIVATE_CHAT_HISTORY_RESPONSE = ProtocolConstants.TYPE_PRIVATE_CHAT_HISTORY_RESPONSE
    CHANNEL_HISTORY_REQUEST = ProtocolConstants.TYPE_CHANNEL_HISTORY_REQUEST
    CHANNEL_HISTORY_RESPONSE = ProtocolConstants.TYPE_CHANNEL_HISTORY_RESPONSE
    PRIVATE_CHAT_MESSAGE_EVENT = ProtocolConstants.TYPE_PRIVATE_CHAT_MESSAGE_EVENT
    CHANNEL_MESSAGE_EVENT = ProtocolConstants.TYPE_CHANNEL_MESSAGE_EVENT
