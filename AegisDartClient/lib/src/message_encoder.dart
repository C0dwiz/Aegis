...
class MessageEncoder {
  ...
  static Uint8List encode(Message message, {BufferPool? bufferPool}) {
    ...
    bd.setUint32(17, payload.length, Endian.big);
  ...
  static Message decode(Uint8List data) {
    ...
    // ── Magic ──────────────────────────────────────────────────────
    message.magic = bd.getUint32(0, Endian.big);
    ...
    const knownFlagsMask = ProtocolConstants.flagRequiresAck |
    ...
    // ── Message type ───────────────────────────────────────────────
    final typeValue = bd.getUint16(7, Endian.big);
    ...
    // ── Sequence ID ────────────────────────────────────────────────
    message.sequenceId = bd.getUint64(9, Endian.big);

    // ── Payload length (validated BEFORE allocation) ───────────────
    final payloadLength = bd.getUint32(17, Endian.big);
