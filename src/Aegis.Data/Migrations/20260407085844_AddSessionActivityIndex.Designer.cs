...
namespace Aegis.Data.Migrations
{
    ...
    [Migration("20260407085844_AddSessionActivityIndex")]
    partial class AddSessionActivityIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aegis.Data.Entities.Channel", b =>
                {
                    ...
                    b.Property<int>("HistoryVisibility")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Aegis.Data.Entities.MessageReaction", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,0)");
                    ...
                    b.HasIndex("Scope", "MessageId", "UserId", "Emoji")
                        .IsUnique();
            ...
            modelBuilder.Entity("Aegis.Data.Entities.SignalChainState", b =>
                {
                    ...
                    b.Property<long>("NextReceivingMessageNumber")
                        .HasColumnType("bigint");

                    b.Property<long>("NextSendingMessageNumber")
                        .HasColumnType("bigint");
